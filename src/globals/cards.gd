...
var cardList = {
	...
	CARDS.ASSASSINATE : CardStats.new(CARDS.ASSASSINATE, -1, "If one of your units could move and kill this piece this turn, instead kill it instantly. X is piece's value", "Assassinate", "res://cards/AssassinateFinal.png", Globals.TARGETS.FRIENDLY_PIECES, 1),
	...
	CARDS.SACRIFICE : CardStats.new(CARDS.SACRIFICE, 0, "Sacrifice one of your pieces and gain X mana where X is the piece's mana value", "Sacrifice", "res://cards/Sacrifice.png", Globals.TARGET.FRIENDLY_PIECE, 1),
	CARDS.RITUAL : CardStats.new(CARDS.RITUAL, 0, "End your turn instanly, not being able to play any more cards or make a chess move. However, on the beginning of your next turn gain however much energy you had when you play this card", "Ritual", "res://cards/ritualFinal.png", Globals.TARGETS.NONE, 0),
	...
	CARDS.SPEAR : CardStats.new(CARDS.SPEAR, 1, "Pawns can also take directly in front of them this turn", "Spear", "res://cards/spear.png", Globals.TARGETS.FRIENDLY_UNIT, 1),
	...
	CARDS.TRIP : CardStats.new(CARDS.TRIP, 2, "Target friendly piece can move into one adjacent empty diagonal tile", "Trip", "res://cards/tripFinal.png", Globals.TARGETS.FRIENDLY_UNIT, 1)
}
